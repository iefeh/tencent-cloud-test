...
export default function PrivilegeScreen() {
  ...
  return (
    <div className="screen-privilege w-full bg-black flex flex-col justify-center items-center pt-[21.3125rem] pb-2 lg:pb-[17.375rem] relative">
      ...
      <div className="flex flex-col items-center relative z-0 w-full">
        ...
        >
          <div ref={cardsContainerRef} className="flex flex-col lg:flex-row items-center lg:items-start justify-center">
          ...
          <div className="rocket absolute right-0 top-1/2 lg:top-[6.25rem] font-poppins-medium text-sm mr-2 lg:mr-[3rem] z-10 hidden lg:block">
