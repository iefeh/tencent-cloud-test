...
export default function ProfilePage() {
  ...
  const { scrollRef, bsRef } = useBScroll({ isMobileOnly: true });
  ...
  return (
    <section
      id="luxy"
      className="w-full flex flex-col px-16 lg:px-[16.25rem] pt-[12.5rem] pb-24 lg:pb-[16rem]mx-auto min-h-screen bg-[url('/img/profile/bg.png')] bg-[length:100%_auto] bg-no-repeat"
    >
      <Head>
