...
async function saveQuests() {
  ...
  const quests = [
    ...
    },
    {
      id: uuidv4(),
      active: true,
      name: 'Verify Your Telegram',
      description: 'Sign in with your Telegram.',
      tip: '',
      type: QuestType.ConnectTelegram,
      properties: null,
      reward: {
        type: QuestRewardType.Range,
        amount_formatted: '10',
    ...
    },
    {
      ...
      description:
        'If you are an early supporter who received the "1st Membership" role in our Discord community, please verify to receive your reward.',
      tip: '',
    ...
    },
    {
      ...
      description:
        "If you're an early supporter of our DC community and have earned MBs, please kindly verify to claim your MBs.",
      tip: '',
