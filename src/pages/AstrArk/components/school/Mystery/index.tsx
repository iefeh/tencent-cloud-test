  ...
  return (
    <div className="mystery absolute left-[4.75rem] bottom-[4.4375rem] flex items-center">
      ...
      >
        ...
        <Image
          className="w-[3.0625rem] h-[2.625rem] z-10"
          src={itemImg}
          alt=""
        />
      </div>
      ...
      >
        <div
          className="text w-[36.5rem] px-11 py-[1.125rem] box-content border rounded-tr-[0.625rem] rounded-br-[0.625rem] border-l-0"
          style={{ borderColor: "rgba(255, 255, 255, 0.2)" }}
        >
          The cycle of the mysterious object continues, bringing apocalyptic
          rebirths. The future of civilization hangs in the balance.
        </div>
      </div>
    </div>
  );
