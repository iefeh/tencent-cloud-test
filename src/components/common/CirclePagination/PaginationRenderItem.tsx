    ...
    return (
      <button
        ...
        className={cn([
          ...
          className,
          activePage < total ? 'border-white text-white' : '!border-[#333333] !text-[#333333] cursor-not-allowed',
        ])}
    ...
    return (
      <button
        ...
        className={cn([
          ...
          className,
          activePage > 1 ? 'border-white text-white' : '!border-[#333333] !text-[#333333] cursor-not-allowed',
        ])}
