...
export default function LineBorder() {
    return (
        <div className='fixed w-full h-full opacity-20 z-10 pointer-events-none' >
            ...
            <div className='absolute right-5 top-1/2 -translate-y-1/2 bg-repeat bg-line-lr h-[9.4rem] w-[0.4rem] bg-[length:100%_.5rem] bg-gradient-to-t from-white from-15% to-transparent to-0%' ></div>
            <div className='absolute bottom-5 bg-line-bottom left-1/2 -translate-x-1/2 bg-repeat w-1/2 h-[0.4rem] bg-[length:.5rem_100%] bg-gradient-to-l from-white from-15% to-transparent to-0%' ></div>
        </div>
    )
