...
export const PoolProps = {
  [PoolType.USDT]: {
    id: 2,
    icon: 'https://d3dhz6pjw7pz9d.cloudfront.net/pledge/icons/icon_usdt.png',
    token: 'USDT',
    contract: '0xaA8E23Fb1079EA71e0a56F48a2aA51851D8433D0',
  },
  [PoolType.USDC]: {
    id: 1,
    icon: 'https://d3dhz6pjw7pz9d.cloudfront.net/pledge/icons/icon_usdc.png',
    token: 'USDC',
    contract: '0x94a9d9ac8a22534e3faca9f4e7f2e2cf85d5e4c8',
  },
  [PoolType.ETH]: {
    id: 0,
    icon: 'https://d3dhz6pjw7pz9d.cloudfront.net/pledge/icons/icon_eth.png',
    token: 'ETH',
    contract: '0x94a9d9ac8a22534e3faca9f4e7f2e2cf85d5e4c8',
  },
};
