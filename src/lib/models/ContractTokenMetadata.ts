...
// 使用既有模型或者新建模型
const ContractTokenMetadata = models.ContractTokenMetadata || model<IContractTokenMetadata>('ContractTokenMetadata', ContractTokenMetadataSchema, 'contract_token_metadata');
