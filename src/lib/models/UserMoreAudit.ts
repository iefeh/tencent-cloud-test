...
export enum UserMoreAuditType {
  ...
  P2AQuest = 'p2a_quest',
  // NFT SBT 验证任务
  NFTSBTQuest = 'nft_sbt_quest',
  // Airdrop
  AIRDROP_CLAIMED = 'airdrop_clear_more',
}
...
const UserMoreAudit =
  models.UserMoreAudit || connection.model<IUserMoreAudit>('UserMoreAudit', UserMoonBeamAuditSchema, 'user_more_audit');
