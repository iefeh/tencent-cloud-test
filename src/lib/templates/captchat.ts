...
<div class="container">
    ...
    <p>Here's your verification code to kickoff your journey</p>
    ...
    <hr>
    <p>Please note that this is an automated message, so there is no need to reply. If you have any questions or need further help, feel free to reach out to us anytime at [<a href="mailto:contact@moonveil.studio">contact@moonveil.studio</a>]</p>
    <p>Welcome aboard!</p>
    <hr>
    <div class="footer">
        <p>Follow Us</p>
