...
const ResponseMessages = {
  ...
  // 钱包签名已过期
  [ResponseCode.ERROR_WALLET_SIGNATURE_EXPIRED]:
    'Wallet Signature Expired. Please Make Sure Your System Time Up To Date',
  // 钱包已经绑定到其他用户
...
export const transactionNotRecongnized = build(ResponseCode.ERROR_TRANSACTION_NOT_RECONGNIZED);
